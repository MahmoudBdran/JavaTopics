...
@Component
public class ParseJsonNodes extends RouteBuilder {
    @Override
                ...
                .process(new Processor() {
                    ...
                    public void process(Exchange exchange) throws Exception {
                        ...
                        for(int i =0 ; i <inputsNode.size();i++){
                            selectedItem =inputsNode.get(i);
                            if(selectedItem.get("name").asText().equals("APPROVAL_NO_")){
                                JsonNode val = selectedItem.get("value");
                                exchange.setProperty("approval_no",val.asText());
                                break;
                            }
                        }
